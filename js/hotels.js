...
window.HOTELS = [
  ...
  {
    id: "nids-de-chlorofil",
    name: "Les Nids de Chlorofil",
    tagline: "Trois cabanes perchées à 8 mètres dans la forêt de Phalempin, à 20 minutes de Lille",
    city: "La Neuville", department: "Nord", region: "Hauts-de-France",
    env: "campagne", type: "cabane", budget: 1,
    lat: 50.4933, lng: 3.0419,
    address: "Forêt de Phalempin, 59239 La Neuville",
    description: [
      "Au cœur de la forêt de Phalempin, à une vingtaine de minutes de Lille, de Lens et de Douai, trois cabanes en bois sont perchées à 8 mètres de hauteur. On y monte par un escalier en bois, et elles sont assez éloignées les unes des autres pour que l'on ne voie pas ses voisins.",
      "La cabane pour deux fait 20 m² avec une terrasse plein sud ; celle pour quatre, 35 m² avec un coin salon ; la plus grande accueille six personnes avec une terrasse de 25 m². Le petit-déjeuner se prend là-haut, et un panier repas aux saveurs du Nord peut compléter la nuit.",
    ],
    highlights: ["Cabanes à 8 mètres de hauteur", "À 20 minutes de Lille", "Cabanes pour 2, 4 ou 6 personnes"],
    amenities: ["Petit-déjeuner", "Panier repas (en option)", "Terrasse perchée", "Bons cadeaux"],
    rooms: "3 cabanes (2, 4 et 6 personnes)",
    season: "Renseignez-vous sur les dates d'ouverture auprès de l'établissement",
    forYou: ["Vous habitez la métropole lilloise et voulez partir sans faire de route", "Vous cherchez une première nuit perchée, à petit prix"],
    notForYou: ["Vous voulez un spa ou un jacuzzi", "Vous avez le vertige"],
    photos: 4, bookingUrl: "", partners: {}, tags: ["famille"],
  },
  {
    id: "cabanes-de-blanche",
    name: "Les Cabanes de Blanche",
    tagline: "Bulles transparentes et cabane perchée avec jacuzzi privatif, dans le jardin d'une fermette de 1735",
    city: "Pommier", department: "Pas-de-Calais", region: "Hauts-de-France",
    env: "campagne", type: "bulle", budget: 2,
    lat: 50.1936, lng: 2.6044,
    address: "Place de la Mairie, 62111 Pommier",
    description: [
      "À Pommier, près d'Arras, Nadine et Bruno ont restauré une fermette de 1735 entourée d'un jardin de 8 500 m² planté de grands arbres, et l'ont baptisée en hommage à Blanche, la grand-mère de Nadine. Depuis 2021, on y dort dans une bulle transparente sous les étoiles ou dans une cabane perchée.",
      "Chaque hébergement a son jacuzzi privatif. La maison propose des repas faits maison avec des produits locaux (petit-déjeuner, planches, dîner) et des massages, en duo ou en solo. Les bulles et la cabane sont affichées à 195 € la nuit en semaine et 209 € le week-end.",
    ],
    highlights: ["Jacuzzi privatif pour chaque hébergement", "Bulles transparentes sous les étoiles", "Fermette de 1735 près d'Arras"],
    amenities: ["Jacuzzi privatif", "Repas faits maison", "Massages", "Plateau de courtoisie", "Bons cadeaux"],
    rooms: "Bulles, une cabane perchée et une chambre d'hôtes",
    season: "Bulles de mi-avril à fin septembre ; cabane perchée ouverte toute l'année",
    forYou: ["Vous préparez une nuit romantique à deux", "Vous rêvez de dormir sous les étoiles avec un bain chaud"],
    notForYou: ["Vous voyagez en famille nombreuse", "Vous cherchez un grand hôtel avec restaurant"],
    photos: 6, bookingUrl: "", partners: {},
  },
  {
    id: "lieu-dieu",
    name: "Lieu Dieu",
    tagline: "Une cabane flottante avec bain nordique sur un domaine de 100 hectares, aux portes de la baie de Somme",
    city: "Beauchamps", department: "Somme", region: "Hauts-de-France",
    env: "campagne", type: "eau", budget: 3,
    lat: 50.0133, lng: 1.5186,
    address: "5 Lieu Dieu, 80770 Beauchamps",
    description: [
      "Sur plus de 100 hectares de prairies, d'étangs et de bois aux portes de la baie de Somme, le domaine de Lieu Dieu s'est transformé en refuge champêtre, à deux heures de Paris ou de Lille. Les chevaux paissent autour des maisons et le centre équestre propose des séjours à cheval.",
      "L'adresse la plus singulière est la cabane sur l'eau : une cabane flottante pour quatre avec son bain nordique privatif chauffé à 38 °C, face à l'étang où passent cygnes et canards. Le domaine compte aussi une roulotte, une yourte, une « Goutte d'Ô » en forme de goutte d'eau, une maison des oiseaux et de grandes maisons pour les tribus.",
    ],
    highlights: ["Cabane flottante avec bain nordique privatif", "Domaine de 100 hectares avec étangs", "Centre équestre sur place"],
    amenities: ["Bain nordique privatif", "Centre équestre", "Paddle et barque (selon hébergement)", "Animaux acceptés", "Parking gratuit"],
    rooms: "Cabane flottante, roulotte, yourte, Goutte d'Ô, maisons et gîtes de groupe",
    forYou: ["Vous aimez les chevaux et les grands espaces", "Vous cherchez une escapade à deux heures de Paris ou de Lille"],
    notForYou: ["Vous voulez un service hôtelier avec restaurant", "Vous cherchez une chambre d'hôtel classique"],
    photos: 6, bookingUrl: "", partners: {}, tags: ["famille", "chien"],
  },
  {
    id: "villa-rene-lalique",
    name: "Villa René Lalique",
    tagline: "Six suites dans la maison du maître verrier, avec une table doublement étoilée",
    city: "Wingen-sur-Moder", department: "Bas-Rhin", region: "Grand Est",
    env: "campagne", type: "design", budget: 4,
    lat: 48.9186, lng: 7.3717,
    address: "18 rue Bellevue, 67290 Wingen-sur-Moder",
    description: [
      "Au cœur des forêts des Vosges du Nord, René Lalique a fait construire cette villa en 1920, près de la verrerie qu'il avait fondée à Wingen-sur-Moder. Devenue hôtel cinq étoiles et membre des Relais & Châteaux, elle ne compte que six suites, chacune décorée autour d'un grand thème de Lalique, avec le cristal de la maison jusque dans les moindres détails.",
      "Le restaurant gastronomique, couronné de deux étoiles au guide Michelin, s'ouvre sur le parc par de grandes baies vitrées, sous des lustres en cristal. On peut prolonger l'expérience au musée Lalique, tout proche, qui retrace l'œuvre du créateur.",
    ],
    highlights: ["La maison de René Lalique (1920)", "Seulement six suites", "Restaurant deux étoiles Michelin"],
    amenities: ["Restaurant gastronomique", "Bar lounge", "Cave à vins", "Parc", "Relais & Châteaux"],
    rooms: "6 suites",
    forYou: ["Vous aimez les arts décoratifs et la grande cuisine", "Vous voulez marquer une grande occasion"],
    notForYou: ["Vous cherchez une nuit nature et rustique", "Vous voyagez avec un petit budget"],
    photos: 6, bookingUrl: "", partners: {},
  },
  {
    id: "cabanes-du-goutty",
    name: "Les Cabanes du Goutty",
    tagline: "Cinq cabanes sur pilotis au bord d'un ruisseau, au pied du Donon",
    city: "Grandfontaine", department: "Bas-Rhin", region: "Grand Est",
    env: "campagne", type: "cabane", budget: 1,
    lat: 48.4953, lng: 7.1675,
    address: "67130 Grandfontaine",
    description: [
      "Dans un vallon boisé au pied du Donon, à moins d'une heure de Strasbourg, cinq cabanes en bois sont perchées sur pilotis entre 3 et 6 mètres de hauteur, au milieu des aulnes et des frênes, bercées par le bruit du ruisseau. On y accède par des escaliers droits.",
      "D'environ 20 m² chacune, elles accueillent deux à quatre personnes : literie fournie, coin repas, lanternes à bougie, chauffage d'appoint et toilettes sèches, avec une terrasse équipée de transats. Le Petit Toit du Monde, octogonal comme une yourte, a une terrasse à 6 mètres traversée par trois arbres. Les premières cabanes sont affichées à partir de 139 € la nuit.",
    ],
    highlights: ["Cabanes perchées de 3 à 6 mètres", "Au bord d'un ruisseau, en pleine forêt", "À moins d'une heure de Strasbourg"],
    amenities: ["Panier du Cabaneur (en option)", "Terrasse avec transats", "Chauffage d'appoint", "Coffrets cadeaux"],
    rooms: "5 cabanes (2 à 4 personnes)",
    forYou: ["Vous voulez une vraie nuit nature, simple et déconnectée", "Vous partez en famille avec de jeunes aventuriers"],
    notForYou: ["Vous tenez à une salle de bains privée", "Vous voulez un spa ou un restaurant sur place"],
    photos: 6, bookingUrl: "", partners: {}, tags: ["famille"],
  },
  {
    id: "domaine-du-chatelet",
    name: "Domaine du Châtelet",
    tagline: "Cabane perchée, cabane du trappeur avec spa privatif et roulotte dans les Hautes-Vosges",
    city: "Ferdrupt", department: "Vosges", region: "Grand Est",
    env: "campagne", type: "cabane", budget: 2,
    lat: 47.8969, lng: 6.7422,
    address: "88360 Ferdrupt",
    description: [
      "Depuis 2007, ce domaine des Hautes-Vosges, entre La Bresse et Gérardmer, dans le parc naturel régional des Ballons des Vosges, accueille les amoureux de nature dans une collection d'hébergements insolites, avec lamas, poneys et étang pour décor.",
      "La cabane dans les arbres accueille deux à quatre personnes, et la cabane du trappeur, sur deux niveaux, a son spa privatif sur la terrasse, en formule chambre d'hôtes avec petits-déjeuners. On peut aussi dormir dans une roulotte, une yourte, une cabane kota à l'esprit nordique ou la minuscule cabane des lutins au bord de l'étang. Sur place : sauna, balnéo, massages et location de VTT électriques.",
    ],
    highlights: ["Cabane du trappeur avec spa privatif", "Cabane perchée pour 2 à 4 personnes", "Entre La Bresse et Gérardmer"],
    amenities: ["Spa privatif (cabane du trappeur)", "Sauna", "Massages", "Location de VTT électriques", "Animaux de la ferme"],
    rooms: "Cabanes, roulotte, yourte et gîtes",
    forYou: ["Vous cherchez un week-end à deux avec bain chaud dans les Vosges", "Vous voyagez avec des enfants qui aiment les animaux"],
    notForYou: ["Vous cherchez une adresse de luxe", "Vous voulez un restaurant gastronomique sur place"],
    photos: 5, bookingUrl: "", partners: {}, tags: ["famille"],
  },
  {
    id: "cabane-du-perche",
    name: "La Cabane du Perche",
    tagline: "Deux cabanes dans les arbres, dont une avec bain nordique face aux collines percheronnes",
    city: "Saint-Mard-de-Réno", department: "Orne", region: "Normandie",
    env: "campagne", type: "cabane", budget: 3,
    lat: 48.5042, lng: 0.6056,
    address: "La Malotière, 61400 Saint-Mard-de-Réno",
    description: [
      "Au cœur du parc naturel régional du Perche, près de Mortagne-au-Perche, deux cabanes sont perchées sur une propriété de 4 hectares au sommet d'une colline, à 50 mètres l'une de l'autre. La vue s'étend sur les bois, les prairies et la campagne normande.",
      "La cabane Spa, pensée pour les couples, a son bain nordique privatif sur la terrasse, chauffé pour votre arrivée, une douche à l'italienne et le chauffage au sol ; elle est affichée à partir de 285 € la nuit pour deux, petit-déjeuner et spa compris. La cabane des Chênes, nichée dans deux chênes bicentenaires, accueille une famille de quatre. Ouvert toute l'année.",
    ],
    highlights: ["Bain nordique privatif face aux collines", "Cabane familiale dans deux chênes bicentenaires", "Ouvert toute l'année"],
    amenities: ["Bain nordique privatif", "Petit-déjeuner inclus", "Peignoirs et chaussons", "Chauffage au sol"],
    rooms: "2 cabanes (couple ou famille de 4)",
    season: "Ouvert toute l'année",
    forYou: ["Vous cherchez un anniversaire ou une Saint-Valentin mémorable", "Vous voulez partir de Paris sans passer le week-end sur la route"],
    notForYou: ["Vous voulez des restaurants à pied", "Vous cherchez une grande structure avec activités"],
    photos: 6, bookingUrl: "", partners: {}, tags: ["famille"],
  },
  {
    id: "landifornia-lodge",
    name: "Landifornia Lodge",
    tagline: "Des cabanes en A, bain nordique au feu de bois et sauna au bord d'un étang landais",
    city: "Saint-Martin-de-Hinx", department: "Landes", region: "Nouvelle-Aquitaine",
    env: "campagne", type: "chalet", budget: 3,
    lat: 43.5822, lng: -1.2689,
    address: "40390 Saint-Martin-de-Hinx",
    description: [
      "À une vingtaine de kilomètres des plages du sud des Landes, deux cabanes inspirées des A-frames américains se cachent dans un écrin de verdure face à un étang. Les propriétaires les ont construites de leurs mains, avec le bois de leurs arbres et des meubles chinés.",
      "La cabane de l'étang, pour deux, a son bain nordique chauffé au feu de bois, son sauna privatif et une douche extérieure à l'eau chaude ; on dort en mezzanine, bercé par les grenouilles. La cabane des bois, plus grande (plus de 40 m²), accueille une famille avec un filet suspendu à l'étage. Affiché à partir de 250 € la nuit, petit-déjeuner compris.",
    ],
    highlights: ["Bain nordique au feu de bois face à l'étang", "Sauna privatif (cabane de l'étang)", "Cabanes construites à la main"],
    amenities: ["Bain nordique privatif", "Sauna privatif", "Petit-déjeuner inclus", "Peignoirs", "Arrivée autonome"],
    rooms: "2 cabanes (2 ou 4 personnes)",
    season: "Ouvert toute l'année",
    forYou: ["Vous aimez l'esprit slow life et les lieux faits main", "Vous voulez combiner nature et plages de l'Atlantique"],
    notForYou: ["Vous voyagez avec un animal (non accepté)", "Vous avez de très jeunes enfants (cabane de l'étang interdite aux moins de 8 ans)"],
    photos: 6, bookingUrl: "", partners: {},
  },
];
